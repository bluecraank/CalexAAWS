...
<body id="pageBody" class="{{ $bgBody }} {{ $textBody }} h-screen relative overflow-hidden">
    ...
    <div class="grid h-screen gap-10 p-10" style="grid-template-columns: 60% 40%;">
        ...
        <div class="flex flex-col justify-between h-full">
            ...
            <div>
                ...
                ->where('start','<=',now())
                    ...
                    {{-- STATUS --}}
                    <div id="status-block" class="mt-8 text-5xl font-semibold">
                    ...
                    @if($current)
                        ...
                        <span class="{{ $textStrong }}">
                            ...
                            @else
                                Noch {{ (int) ($remaining / 60) }} Std. {{ $remaining % 60 }} Min. belegt
                            @endif
                        </span>
                    @elseif($next)
                        <span class="{{ $textStrong }}">
        ...
        <div style="max-height: 100%; overflow: auto" class="{{ $bgCard }} rounded-2xl shadow-xl border {{ $borderCard }} flex flex-col">
            ...
            <div class="p-8 flex flex-col flex-1 min-h-0">
                ...
                <div>
                    ...
                    <div style="display: inline-block; float:right" id="clock" class="text-3xl text-white-400 mt-3 font-mono"></div>
                </div>
            ...
            <div id="action-button" class="p-8 pt-0 shrink-0">
                ...
                <button
                    ...
                    class="w-full bg-red-500 text-white font-semibold py-4 text-lg rounded-xl hover:bg-red-600 transition">
                    Termin beenden
                </button>
